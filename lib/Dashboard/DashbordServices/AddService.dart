  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<DashBoardCubit,DashBoardStates>(
      listener:  (context, state) {
        if(state is ADDServiceSucssessfullStateStates){
            ...
            children: [
              Container(
                ...
                child:  ConditionalBuilder(
                  condition: state is !ADDServiceLoadStateStates,
                ...
                child: button(
                    ...
                    onPressed:(){
                      if(serviceController.text.isNotEmpty){
                        DashBoardCubit.get(context).addService(serviceController.text);
                      }
                      else{
                        showToast(text: "Pleas enter the service", state: ToastStates.SUCCESS);
                      }
                    },
                    text:"Add",
                    height: 50,
