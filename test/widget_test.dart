...
//
//   // إعداد القناة إذا لزم الأمر
//   const AndroidNotificationChannel channel = AndroidNotificationChannel(
//     'unique_channel_id', // يجب أن يكون هذا المعرّف نفسه المستخدم عند عرض الإشعار
//     'Message Notifications',
//     importance: Importance.high,
//     playSound: true,
//   );
//
//   final AndroidFlutterLocalNotificationsPlugin? androidNotifications = flutterLocalNotificationsPlugin.resolvePlatformSpecificImplementation<AndroidFlutterLocalNotificationsPlugin>();
//   if (androidNotifications != null) {
//     await androidNotifications.createNotificationChannel(channel);
//   } else {
//     print('Error: Android notification implementation not found');
//   }
// }
//
...
// }
//
// Future<void> showNotification(String message, String senderName) async {
//   try {
//     const AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
//       'unique_channel_id', // نفس المعرف
//       'Message Notifications',
